...
sendvtcgpspytest_spec = ["implementation_id", "SendVTCGpsPyTest",
		 "type_name",         "SendVTCGpsPyTest",
...
##
# @class SendVTCGpsPyTest
# @brief ModuleDescription
#
#
class SendVTCGpsPyTest(OpenRTM_aist.DataFlowComponentBase):
	...
	def __init__(self, manager):
		...
		"""
		"""
		self._GpsDataIn = OpenRTM_aist.InPort("GpsData", self._d_GpsData)
	...
	def onInitialize(self):
		...
		# Set InPort buffers
		self.addInPort("GpsData",self._GpsDataIn)
...
def SendVTCGpsPyTestInit(manager):
    profile = OpenRTM_aist.Properties(defaults_str=sendvtcgpspytest_spec)
    manager.registerFactory(profile,
                            SendVTCGpsPyTest,
                            OpenRTM_aist.Delete)

def MyModuleInit(manager):
    SendVTCGpsPyTestInit(manager)

    # Create a component
    comp = manager.createComponent("SendVTCGpsPyTest")
